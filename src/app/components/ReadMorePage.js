  ...
  return (
    <div className="container mx-auto p-4">
      <header className="text-center mb-8">
        <h1 className="text-4xl font-bold">About Thanks-Chat</h1>
      </header>
      <main>
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2">Welcome to Thanks-Chat</h2>
          <p>
          Thanks-Chat is the premier platform for project builders to collect funds and bring their visions to life. Whether you are an artist, entrepreneur, developer, or social activist, Thanks-Chat provides the tools and support you need to gather financial backing and connect with a community of supporters who believe in your project.
          </p>
        </section>
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2">Why Choose Thanks-Chat?</h2>
          <ul className="list-disc list-inside">
            ...
            <li><strong>Support for All Types of Projects:</strong> No matter the size or scope of your project, Thanks-Chat is here to help. From small community initiatives to large-scale innovations, our platform is versatile enough to accommodate a wide range of projects.</li>
            ...
            <li><strong>Secure Payment Processing:</strong> We prioritize the security of your funds and personal information. Thanks-Chat exclusively supports Razorpay as our payment gateway to ensure seamless and secure transactions.</li>
          </ul>
        </section>
        <section className="mb-8">
        ...
        <section className="mb-8">
          ...
          <p>To receive funds through Thanks-Chat, it is essential that you have a Razorpay account. Razorpay is a leading payment gateway provider known for its reliability and security. Here’s why you need it:</p>
          ...
          <ul className="list-disc list-inside">
            ...
            <li><strong>Seamless Integration:</strong> Easily link your Razorpay account to Thanks-Chat for smooth and hassle-free payment processing.</li>
          ...
          <ol className="list-decimal list-inside">
            ...
            <li><strong>Link to Thanks-Chat:</strong> Enter your Razorpay Account ID and Secret Key on your Thanks-Chat Dashboard to enable payment processing.</li>
          </ol>
        </section>
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2">Start Your Journey Today</h2>
          <p>Don&apos;t let funding be a barrier to your dreams. Join Thanks-Chat and connect with a community that wants to see you succeed. Create your project today, share your vision, and start collecting the funds you need to make your project a reality.</p>
          <p>For more information or assistance, feel free to <a href="mailto:support@thanks-chat.com" className="text-blue-600 underline">contact our support team</a>. We’re here to help you every step of the way.</p>
        </section>
      </main>
      <footer className="text-center mt-8">
        <p><strong>Thanks-Chat</strong> - Empowering creators, one token at a time.</p>
      </footer>
    </div>
  );
};
